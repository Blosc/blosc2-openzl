...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({'quality_mode': 'rates',
          ...
          'rateControlAlgorithm': blosc2_openzl.GrkRateControl.PCRD_OPT}
        ),
        ...
        ({'max_comp_size': 10**9}),
        ({'rsiz': blosc2_openzl.GrkProfile.GRK_PROFILE_0}),
        ({'rsiz': blosc2_openzl.GrkProfile.GRK_PROFILE_1}),
...
def test_jp2(image, kwargs, leading_dims):
    ...
    blosc2_openzl.set_params_defaults(**kwargs)
